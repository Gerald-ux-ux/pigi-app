...
export const WithdrawSuccessModal = ({ visible, onClose }) => {
      ...
      <TouchableOpacity disabled={true} style={styles.container}>
        <View style={[styles.modal, styles.centered]}>
          ...
          <View className="mx-8">
            ...
            <Text className="text-base text-center">Withdrawal successful</Text>
            <Text className="text-center pt-4  text-xs text-[#817f7f]">
              You’ll receive your money within 3 business days
            </Text>
          </View>
        </View>
